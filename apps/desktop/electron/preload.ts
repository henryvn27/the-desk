...
const api: DeskAPI = {
  ...
  selectProvider: (mode) => ipcRenderer.invoke("desk:provider-select", mode),
  connectChatGPT: () => ipcRenderer.invoke("desk:provider-connect-chatgpt"),
  disconnectChatGPT: () => ipcRenderer.invoke("desk:provider-disconnect-chatgpt"),
  ...
  studyStatus: () => ipcRenderer.invoke("desk:study-status"),
  studyGenerate: (value) => ipcRenderer.invoke("desk:study-generate", value),
