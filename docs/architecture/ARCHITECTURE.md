...
- `packages/planner` is deterministic. First slice handles confirmed deadlines, capacity, minimum useful blocks and honest unallocated work. Grade impact, dependency scheduling, locks, learning, multi-day spacing and time-zone preference are still open.
