...
- Local outbox is durable intent only. It is NOT working Supabase sync. The account boundary can authenticate through Supabase from Electron main, but no remote copy or cloud sync is claimed.
